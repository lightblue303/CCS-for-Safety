...
from app.api.v1.schemas.push_tokens import PushTokenRegisterRequest, PushTokenRegisterResponse
from app.services.push_tokens_service import register_push_token
